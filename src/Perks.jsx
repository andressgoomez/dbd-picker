...
const Perks = () => {
  ...
  return (<>
    <StyledContainer>
      ...
      <StyledBody>
        <Image src='/noed.png' width='180px'></Image>
        <Text textShadow='4px 4px 2px #000000' fontSize='6xl' color='#7c2578' minWidth='200px' fontWeight='extrabold'>¡ELIGE TUS KILLER PERKS!</Text>
        <Spacer />
        ...
        <Link to='/killers'><Button mt={14} mb={5} colorScheme='red' width='250px' height='50px' ><Center><Text fontSize='2xl' textShadow='2px 2px 2px #000000' color='white' fontWeight='bold'>ELIGE TU KILLER</Text><Text fontSize='xl' ml={2} ><FaArrowRight /></Text></Center></Button></Link>
